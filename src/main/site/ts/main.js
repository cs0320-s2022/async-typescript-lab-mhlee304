...
sun.addEventListener('input', function () { return postAndUpdate(); });
moon.addEventListener('input', function () { return postAndUpdate(); });
rising.addEventListener('input', function () { return postAndUpdate(); });
function postAndUpdate() {
    // TODO: empty the suggestionList (you want new suggestions each time someone types something new)
    //  HINT: use .innerHTML
    suggestions.innerHTML = "";
    // TODO: add a type annotation to make this of type MatchesRequestData
    var postParameters = { sun: sun.value, moon: moon.value, rising: rising.value
    ...
    }).then(function (data) { return updateSuggestions(data.matches); });
...
function updateSuggestions(matches) {
    ...
    while (i < matches.length) {
        var curr = matches[i];
        suggestions.innerHTML += "<li tabindex=\"0\">".concat(curr, "</li>");
        i++;
        console.log(i);
    }
...
document.addEventListener('keyup', function (key) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, updateValues(sun.value, moon.value, rising.value)];
            case 1:
                _a.sent();
                postAndUpdate();
                return [2 /*return*/];
